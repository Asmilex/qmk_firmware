...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______,     KC_P7,   KC_P8,   KC_P9,   _______, _______, _______, _______, _______, KC_MUTE, KC_MPLY, KC_MPRV, KC_MNXT, KC_PSCR,      KC_HOME,
        _______,       KC_P4,   KC_P5,   KC_P6,   _______, _______, _______, _______, _______, KC_LOCK, _______, _______, _______,             KC_END,
        _______,   _______, KC_P1,   KC_P2,   KC_P3,   _______, _______, _______, _______, _______, _______, _______, KC_BTN1,        KC_MS_U, KC_BTN3,
