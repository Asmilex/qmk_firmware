...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI,  KC_LALT,                       KC_SPC,                              KC_RALT, LT2_APP, KC_RGUI, KC_LEFT, KC_DOWN,  KC_RGHT
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
        _______,      KC_P7,    KC_P8,   KC_P9,   KC_PPLS,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  _______, _______, _______,
        ...
        KC_NUMLOCK,  _______,   _______,                      _______,                              _______, _______, _______, _______, _______, _______
    ),
};
